...
export default function PenjualanOfflinePage() {
  ...
  const fetchData = async (
    ...
    setLoading(true);
    try {
      const params: Record<string, any> = { page: p, limit: 20, tipe };
      ...
      <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 4 }}>
        <Box>
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5, mb: 0.5 }}>
            ...
            <Typography variant="h4" sx={{ fontWeight: 800, color: 'text.primary' }}>Penjualan Offline</Typography>
          </Box>
          <Typography variant="body2" color="text.secondary">Total {total} transaksi tercatat</Typography>
        </Box>
