...
type OnlineRow = { id:number; id_pesanan:string; channel:string; nama_pelanggan:string; no_hp:string; jasa_kirim:string; nomor_resi?:string|null; tanggal:string; status:string; total_tagihan:number; total_bayar:number; qty_net:number; };
