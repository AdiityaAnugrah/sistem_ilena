  ...
  return (
    <AuthGuard>
      <div className="flex h-screen overflow-hidden" style={{ background: '#f8fafc' }}>
        ...
        <div className="lg:hidden absolute top-0 left-0 right-0 h-[64px] bg-white border-b z-40 flex items-center px-4 justify-between" style={{ borderColor: '#e2e8f0', boxShadow: '0 1px 2px rgba(0,0,0,0.03)', paddingTop: 'env(safe-area-inset-top)' }}>
          ...
          <div className="flex min-w-0 flex-1 items-center justify-end gap-2">
            <div className="min-w-0 flex-1 max-w-[210px]">
              <GlobalSearch />
            </div>
            <button
              onClick={() => setSidebarOpen(!isSidebarOpen)}
              className="min-h-[44px] min-w-[44px] rounded-xl text-slate-600 hover:bg-slate-100 transition-colors flex items-center justify-center"
        ...
        {/* Main Content */}
        <main className="flex-1 w-full lg:ml-[260px] pt-[64px] lg:pt-0 pb-[86px] lg:pb-0 overflow-y-auto">
          {isTestMode && (
            <div style={{
          ...
          <div className="p-3 sm:p-4 md:p-6 lg:p-7 animate-fade-in max-w-[100vw] lg:max-w-none">{children}</div>
        </main>
