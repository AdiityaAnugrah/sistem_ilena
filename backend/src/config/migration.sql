...
CREATE TABLE IF NOT EXISTS penjualan_interior (
  ...
  nama_pt_npwp VARCHAR(150) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS penjualan_online (
  ...
  channel VARCHAR(80) NOT NULL DEFAULT 'LAINNYA',
  nama_pelanggan VARCHAR(120) NOT NULL,
  no_hp VARCHAR(25) NOT NULL,
  metode_pembayaran VARCHAR(80) NOT NULL,
  ...
  kurangi_stok TINYINT(1) NOT NULL DEFAULT 1,
  catatan TEXT NULL,
